                            ...
                            <table class='table table-bordered table-striped'>
                                <thead>
                                    <tr>
                                        ...
                                        <th>Code</th>
                                        <th>Name</th>
                                        <th width="200px">Old Price</th>
                                        <th width="200px">New Price</th>
                                        <th width="50px">#</th>
                                    </tr>
                                </thead>
...
<script>
    ...
    function loadDataList() {
        fetch("/_server/product_price_change.php")
            .then(resp => resp.text())
    ...
    function addPrice(id, price) {
        fetch("/_server/product_price_change.php?id=" + id + "&price=" + price)
            .then(resp => resp.text())
            .then(loadDataList)
            .catch()
    }
    ...
    function sitemClear() {
        fetch("/_actions/sitem_clear.php?price-item=1")
            .then(resp => resp.text())
            .then(loadDataList())
            .catch()
    }
    ...
    function deleteProduct(id) {
        fetch("/_server/product_price_change.php?del_id=" + id)
            .then(resp => resp.text())
            .then(loadDataList())
            .catch()
    }
    //save
    function save() {
        fetch("/_server/product_price_change.php?save=" + 1)
            .then(resp => resp.text())
            .then(loadDataList())
            .catch()
    }
